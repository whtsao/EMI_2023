...
opts= Context.Options([
    ...
    ("TLD_type",False,"True if the TLD is on"),
...
# forcing frequency
fr = opts.fr
fn = opts.fnz # aim at roll motion
fc = fr*fn
...
caisson.translate(np.array([0.5*water_length, water_level+0.5*body_h-yst])) # 0.9 is to place the floating structure higher than the stactic position
